...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=ijZxDBpK#Ign_vzIprYja3ETBxCuWfes3RQvPrCiEVgK_XrAKhrw' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '260771798128,260767829703' : process.env.SUDO,
SESSION_NAME: process.env.PORT === undefined ? "asitha" : process.env.SESSION_NAME,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , king Cyrus is alive mf wassup!!*" : process.env.ALIVE_MSG,
...
TIKTOK_SEND_JID: process.env.TIKTOK_SEND_JID === undefined ? "https://vm.tiktok.com/ZMks49fp4/ This post is shared via TikTok Lite. Download TikTok Lite to enjoy more posts: https://www.tiktok.com/tiktoklite" : process.env.TIKTOK_SEND_JID,
